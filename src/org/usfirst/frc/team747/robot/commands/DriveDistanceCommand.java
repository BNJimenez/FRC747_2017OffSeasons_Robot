...
public class DriveDistanceCommand extends Command {
    ...
    public DriveDistanceCommand(double distanceInches, double speed) {
        ...
        this.inchesToTravel = (distanceInches / 64);
        this.speed = speed;
...
//        Robot.DRIVE_TRAIN.set(0, 0);
        ...
        Robot.DRIVE_TRAIN.talonDriveRightMid.changeControlMode(CANTalon.TalonControlMode.Follower);
        Robot.DRIVE_TRAIN.talonDriveLeftBack.changeControlMode(CANTalon.TalonControlMode.Follower);
        Robot.DRIVE_TRAIN.talonDriveRightBack.changeControlMode(CANTalon.TalonControlMode.Follower);
        Robot.DRIVE_TRAIN.set(0, 0);
        Robot.DRIVE_TRAIN.resetBothEncoders();
    }
